...
const benefits = [
  ...
  { title: "Комиссия 15%", desc: "Одна из самых низких на рынке. Приводите своих клиентов — всего 3%." },
        ...
        <section className="py-20 sm:py-28 bg-gray-50">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Первые 100 хостов получают <span className="font-bold text-primary">0% комиссии на 6 месяцев</span> + бесплатную профессиональную фотосъёмку
            </p>
            <div className="mt-8">
              <Link
                href="/register?role=host"
